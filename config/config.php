...
# What is the name of this app?
	define('APP_NAME', 'Blubber');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	//define('APP_EMAIL', 'webmaster@sample-app.com');
        define('APP_EMAIL', 'webmaster@p2.hanhan.biz');
...
*/ 	
	define('SYSTEM_EMAIL', 'hchou@fas.harvard.edu'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', '5q18BB48BQA9U8WH19Lgs1NOocI1O6BUGILjjDTy');
	define('TOKEN_SALT', 'MPDKtliPpif9HpNtBx1pfWwETISDom2e5Ec9uW2M');
